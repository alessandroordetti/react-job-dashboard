          ...
          <div className='grid grid-cols-1 md:grid-cols-[70%_30%] w-full gap-6'>
            ...
            <aside>
              ...
              <div className='bg-white p-6 rounded-lg shadow-md mt-6'>
                ...
                <Link
                  to={`/edit-job/${job.id}`}
                  className='bg-indigo-500 hover:bg-indigo-600 text-white text-center font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline mt-4 me-2'
                >
                  Edit Job
                </Link>
                <button
                  onClick={() => onDeleteClick(job.id)}
                  className='bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline mt-4 '
                >
                  Delete Job
                </button>
              </div>
